...
const socialLinks = [
    {
      href: 'https://github.com/Lavakumar03',
    ...
    {
      href: 'https://www.linkedin.com/in/arigela-lavakumar/',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://x.com/A_LavaKumar_03',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://www.instagram.com/_lava_kumar_naidu_/',
  ...
  return (
   ...
   className="section">
    <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <h2 className="headline-3 lg:max-w-[25ch]"> 
          Contact me for collaboration
          </h2> 
          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">
          Let's collaborate and bring your project to life—reach out now!
          </p>
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon}, key) => (
                ...
                key ={key}
                href={href}
                target="_blank" className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80">
                  {icon}  
                </a>
            ))}
          </div>
        </div>
        <form action="https://submit-form.com/IwYuZhLHz" method="POST" 
        ...
        <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                ...
                <div className="mb-4">
                    ...
                    autoComplete = "email"
                    required
                    placeholder="lavakumararigela@gmail.com"
                    className="text-field" />
                </div>             
            </div>
            <div className="mb-4">
